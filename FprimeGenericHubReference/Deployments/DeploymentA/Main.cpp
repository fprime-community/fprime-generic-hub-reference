...
#include <FprimeGenericHubReference/Deployments/DeploymentA/Top/DeploymentATopology.hpp>
...
static void signalHandler(int signum) {
    FprimeGenericHubReference::DeploymentA::stopRateGroups();
}
...
int main(int argc, char* argv[]) {
    ...
    FprimeGenericHubReference::DeploymentA::TopologyState inputs;
    ...
    FprimeGenericHubReference::DeploymentA::setupTopology(inputs);
    FprimeGenericHubReference::DeploymentA::startRateGroups(Fw::TimeInterval(1, 0));  // Program loop cycling rate groups at 1Hz
    FprimeGenericHubReference::DeploymentA::teardownTopology(inputs);
    (void)printf("Exiting...\n");
    return 0;
}
