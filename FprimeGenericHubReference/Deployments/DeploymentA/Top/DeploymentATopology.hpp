// ======================================================================
// \title  DeploymentATopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef DEPLOYMENTA_DEPLOYMENTATOPOLOGY_HPP
#define DEPLOYMENTA_DEPLOYMENTATOPOLOGY_HPP
// Included for access to DeploymentA::TopologyState and DeploymentA::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <FprimeGenericHubReference/Deployments/DeploymentA/Top/DeploymentATopologyDefs.hpp>

// Remove unnecessary DeploymentA:: qualifications
//using namespace DeploymentA;
 ...
 * DeploymentA::TopologyState see: DeploymentATopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type DeploymentA::TopologyState see: DeploymentATopologyDefs.hpp.
 *
