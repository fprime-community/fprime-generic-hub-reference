// ======================================================================
// \title  DeploymentBTopology.hpp
// \brief header file containing the topology instantiation definitions
//
// ======================================================================
#ifndef DEPLOYMENTB_DEPLOYMENTBTOPOLOGY_HPP
#define DEPLOYMENTB_DEPLOYMENTBTOPOLOGY_HPP
// Included for access to DeploymentB::TopologyState and DeploymentB::ConfigObjects::pingEntries. These definitions are required by the
// autocoder, but are also used in this hand-coded topology.
#include <FprimeGenericHubReference/Deployments/DeploymentB/Top/DeploymentBTopologyDefs.hpp>

// Remove unnecessary DeploymentB:: qualifications
 ...
 * DeploymentB::TopologyState see: DeploymentBTopologyDefs.hpp.
 *
 ...
 *
 * For an explanation of the required type DeploymentB::TopologyState see: DeploymentBTopologyDefs.hpp.
 *
