...
#include <FprimeGenericHubReference/Deployments/DeploymentB/Top/DeploymentBTopology.hpp>
...
static void signalHandler(int signum) {
    FprimeGenericHubReference::DeploymentB::stopRateGroups();
}
...
int main(int argc, char* argv[]) {
    ...
    FprimeGenericHubReference::DeploymentB::TopologyState inputs;
